...
import upload from '../middleware/upload.middleware.js'; // Ensure this matches your project's upload middleware path
...
// FIXED: Added upload.single('image') to support file uploads & AI detection
router.post('/documents', upload.single('image'), postOfficialDocument);
