...
export default function FoundDashboardLayout() {
  ...
  const navLinks = [
    { path: "/found-dashboard", label: t("dashboard.dashboard"), end: true },
    { path: "/found-dashboard/profile", label: t("profile.myProfile") },
    { path: "/found-dashboard/my-found-items", label: t("items.myFoundItems") },
    { path: "/found-dashboard/post-found-item", label: t("items.postFoundItem") },
    { path: "/found-dashboard/matches", label: t("matches.potentialMatches") },
    { path: "/found-dashboard/document-scanner", label: t("items.image") + " Scanner" },
    { path: "/found-dashboard/messages", label: t("notifications.notifications"), badge: unreadCount },
  ];
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
              ...
              <div>
                ...
                <ul className="text-xs space-y-3 font-medium">
                  <li><Link to="/found-dashboard" className="hover:text-white transition">{t("dashboard.dashboard")}</Link></li>
                  <li><Link to="/found-dashboard/profile" className="hover:text-white transition">{t("profile.myProfile")}</Link></li>
                  <li><Link to="/found-dashboard/messages" className="hover:text-white transition">{t("notifications.notifications")}</Link></li>
                </ul>
              </div>
