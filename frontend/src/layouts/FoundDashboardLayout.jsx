      ...
      <div className="flex flex-1">
        ...
        `}>
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 font-bold text-white text-sm">{user?.full_name || 'Found User'}</p>
          ...
          <nav className="space-y-1.5 text-sm">
            {navLinks.map((link) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `block px-4 py-2.5 rounded-lg transition font-semibold relative ${
                    isActive
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <ul className="text-xs space-y-1.5">
              ...
              <li className="hover:text-green-300 transition cursor-pointer">My Found Items</li>
